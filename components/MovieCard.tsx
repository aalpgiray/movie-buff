		...
		>
			...
			>
				<div className="aspect-[2/3] relative overflow-hidden">
					...
					<div className="absolute top-2 right-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100 z-10">
						<Button
							size="icon"
							variant={isSeen ? "secondary" : "default"}
							onClick={(e) => {
								e.preventDefault(); // Prevent navigation when clicking the eye
								e.stopPropagation();
